...
func TestApplierSCC_getColumnToApply(t *testing.T) {
	...
	cases := []struct {
		...
		// // SCC does not consider Deps thus it is not aware of 0 after 1.
		// // 0 after 1:
		// // |.-----.
		// // |v     v
		// // |0->1->2
...

		{
			name: "0->1<>2->0, from 0",
			columns: []*Column{
				{Log: []*Ins{nil, {Deps: []int64{0, 2, 1}}}},
				{Log: []*Ins{nil, {Deps: []int64{0, 0, 2}}}},
				{Log: []*Ins{nil, {Deps: []int64{2, 2, 0}}}},
			},
			nextCommits: []int64{2, 2, 2},
			nextApply:   []int64{1, 1, 1},
			column:      0,
		...
		},
		{
			name: "0->1->2->0, from 1",
			columns: []*Column{
				{Log: []*Ins{{Deps: []int64{0, 1, 0}}}},
				{Log: []*Ins{{Deps: []int64{0, 0, 1}}}},
				{Log: []*Ins{{Deps: []int64{1, 0, 0}}}},
			},
